    ...
    public class ProductProvider : IProductProvider
    {
        ...
        private void SeedData()
        {
            if(!dbContext.Products.Any())
            {
                ...
                dbContext.Products.Add(new Db.Product() { Id = 2, Name = "Mouse", Price = 5, Inventory = 2 });
                dbContext.Products.Add(new Db.Product() { Id = 3, Name = "Monitor", Price = 150, Inventory = 5 });
                dbContext.Products.Add(new Db.Product() { Id = 4, Name = "CPU", Price = 200, Inventory = 7 });
